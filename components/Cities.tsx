const citiesInIndia = [
    ...
    'Jamnagar', 'Ujjain', 'Loni', 'Siliguri', 'Jhansi', 'Ulhasnagar', 'Jammu', 'Sangli-Miraj & Kupwad', 'Mangalore', 'Erode', 'Belgaum',
    'Ambattur', 'Tirunelveli', 'Malegaon', 'Gaya', 'Jalgaon', 'Udaipur', 'Maheshtala', 'Tirupur', 'Davanagere', 'Kozhikode', 'Akbarpur',
    'Shahjahanpur', 'Satara', 'Bijapur', 'Kurnool', 'Rajahmundry', 'Bokaro Steel City', 'Bilaspur', 'Agartala', 'Latur', 'Dhule', 'Korba',
    'Bhilwara', 'Berhampur', 'Muzaffarpur', 'Ahmednagar', 'Mathura', 'Kollam', 'Avadi', 'Kadapa', 'Kamarhati', 'Sambalpur', 'Bilaspur',
    'Shahjahanpur', 'Satara', 'Bijapur', 'Kurnool', 'Rajahmundry', 'Bokaro Steel City', 'Bilaspur', 'Agartala', 'Latur', 'Dhule', 'Korba',
